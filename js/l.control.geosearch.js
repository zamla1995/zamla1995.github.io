...
L.Control.GeoSearch = L.Control.extend({
    ...
    setConfig: function (options) {
        this._config = {
            ...
            'searchLabel': options.searchLabel || 'Введите адрес и нажмите Enter',
            'notFoundMessage' : options.notFoundMessage || 'Извините, этот адрес не может быть найден.',
    ...
    onAdd: function (map) {
        ...
        if ($controlContainer.children('.leaflet-top.leaflet-center').length == 0) {
            $controlContainer.append('<div class="leaflet-top leaflet-center" id = "test"></div>');
